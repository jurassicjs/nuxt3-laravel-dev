...
function registerUser() {
  fetch(`${config.CUSTOM_API_URL}/register`, {
    method: 'POST',
  ...
  <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <form v-on:submit.prevent class="mt-8 space-y-6" action="#" method="POST">
        ...
        <div>
          <button @click="registerUser" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
